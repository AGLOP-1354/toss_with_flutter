import 'package:toss_app/common/constant/app_colors.dart';
import 'package:flutter/material.dart';

export 'package:toss_app/common/constant/app_colors.dart';
...
abstract class AbstractThemeColors {
  ...
  Color get buttonBackground => const Color.fromARGB(255, 48, 46, 46);

  Color get roundedLayoutBackground => const Color.fromARGB(255, 24, 24, 24);

  Color get unreadColor => const Color.fromARGB(255, 48, 46, 46);
  ...
  Color get minus => const Color.fromARGB(255, 9, 10, 216);
}
